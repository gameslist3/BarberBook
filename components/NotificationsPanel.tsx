...
export function NotificationsPanel({
  ...
  return (
    <div className="w-[300px] sm:w-80 bg-white rounded-2xl shadow-2xl border border-gray-200 z-[999] overflow-hidden" style={{ animation: 'slideUpFade 0.25s cubic-bezier(0.16, 1, 0.3, 1) both' }}>
      {/* Header */}
