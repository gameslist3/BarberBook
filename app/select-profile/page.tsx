...
export default async function SelectProfilePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 dark:bg-gray-800 px-5 py-10">
      <div className="mb-8 text-center w-full max-w-md">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Welcome, {user.name}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full max-w-xl">
        <Link
          href="/explore"
          className="group relative rounded-2xl bg-white dark:bg-gray-900 p-5 md:p-8 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-50 dark:border-gray-900 hover:shadow-lg hover:border-violet-200 hover:-translate-y-0.5 transition-all text-center flex flex-col items-center"
        >
          ...
          <h2 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-1.5">Client Profile</h2>
        ...
        >
          ...
          <h2 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-1.5">Shop Owner Profile</h2>
