  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-5 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full max-w-xl">
        <Link
          href="/explore"
          className="group relative rounded-2xl bg-white p-5 md:p-8 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-50 hover:shadow-lg hover:border-violet-200 hover:-translate-y-0.5 transition-all text-center flex flex-col items-center"
        >
